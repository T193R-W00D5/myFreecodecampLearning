...
const testCases: {
  ...
  fixture: 'fixture_startFrom_Home' |
...

  {
    ...
    links: [
      { 
        ...
        expectedAriaLabel: sharedConstants_main.ariaLabels.ariaLabel_homeLink_header,  // hardcoded example: expectedAriaLabel: "Top of the page Home link to go to the website's main home page"
      },
    ],
  },

  {
    ...
    links: [
      { 
        ...
        expectedAriaLabel: sharedConstants_main.ariaLabels.ariaLabel_homeLink_footer,
      },
    ],
  },
...
test.describe.parallel('Validate multiple links in regions - Dynamic Approach', () => {
  for (const { fixture, regionLocator, links } of testCases) {
    test(`validate links in ${fixture} (${regionLocator}) @smoke`, 
        async ({ 
